...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--with_storage',
            help=u'Store the blocks in Storage, overriding value of the storage_backing_for_cache waffle switch',
            action='store_true',
            default=False,
        )
    ...
    def handle(self, *args, **options):
        ...
        log.warning(u'STARTED generating Course Blocks for %d courses.', len(course_keys))
